    ...
    void render(const hittable& world) {
        ...
        taskflow.for_each_index(0, image_height, 1, [&](int j) {
            ...
            for (int i = 0; i < image_width; i++) {
                ...
                write_color(image_buffer, pixel_index, pixel_samples_scale * pixel_color);
            }
        });
        ...
        std::clog << "\nRender calculation took: " << render_time.count() << " seconds.\n";
        std::clog << "Outputting to PPM...\n";

        // Output in PPM
        std::cout << "P3\n" << image_width << ' ' << image_height << "\n255\n";
        for (size_t k = 0; k < image_buffer.size(); k += 3)
        {
